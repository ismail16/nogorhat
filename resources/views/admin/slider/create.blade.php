                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="{{route('admin.slider.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="textarea"  name="slider_text" rows="5" placeholder="Product Descriptions" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" class="btn btn-sm btn-info float-right"><i class="fa fa-plus"></i> Add New</button>
                            </div>
                        </form>
                    </div>
                </div>
