                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <a href="{{route('admin.terms-condition.create')}}" class="pull-right btn btn-sm btn-primary float-right ml-2"> <i class="fa fa-plus"></i> Add New</a>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form id="on_delete{{$loop->index+1}}"
                                              action="{{route('admin.terms-condition.destroy', $terms_condition->id)}}"
                                              method="post" class="delete"
                                              data-content="{{$terms_condition->id}}"
                                              style="display: none;">
                                            {{csrf_field()}}
                                            {{method_field('DELETE')}}
                                        </form>
